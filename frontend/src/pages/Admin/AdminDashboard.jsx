...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        <h1 className="text-4xl lg:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-500 pb-1 tracking-tight">
          {t("Assalamu Alaikum")}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {/* Total Students Card */}
        <div className="bg-white dark:bg-zinc-900/65 backdrop-blur-md p-6 rounded-3xl border border-slate-100 dark:border-zinc-900 shadow-premium hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-black uppercase tracking-wider text-slate-400 dark:text-zinc-500">{t("Total Students")}</p>
              <p className="text-4xl font-black mt-3 text-slate-900 dark:text-white">{totalStudents}</p>
            </div>
            <div className="w-14 h-14 rounded-2xl bg-blue-500/10 dark:bg-blue-500/15 border border-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-2xs">
              <Users size={24} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900/65 backdrop-blur-md p-6 rounded-3xl border border-slate-100 dark:border-zinc-900 shadow-premium hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-black uppercase tracking-wider text-slate-400 dark:text-zinc-500">{t("Total Ustazs")}</p>
              <p className="text-4xl font-black mt-3 text-slate-900 dark:text-white">{ustazs.length}</p>
              <div className="flex items-center gap-2 mt-3 text-xs font-bold text-slate-500 dark:text-zinc-400 bg-slate-50 dark:bg-zinc-800/40 px-2.5 py-1 rounded-xl w-max border border-slate-100 dark:border-zinc-800/60">
            ...
            <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 dark:bg-indigo-500/15 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-2xs">
              <User size={24} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900/65 backdrop-blur-md p-6 rounded-3xl border border-slate-100 dark:border-zinc-900 shadow-premium hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-black uppercase tracking-wider text-slate-400 dark:text-zinc-500">{t("Today's Attendance")}</p>
              <p className="text-4xl font-black mt-3 text-slate-900 dark:text-white">{attendancePercentage}%</p>
            </div>
            <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 dark:bg-emerald-500/15 border border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shadow-2xs">
              <Calendar size={24} />
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-1.5">
            ...
            <div className="flex items-center gap-2.5 text-[11px] font-bold text-slate-600 dark:text-zinc-300 bg-slate-100/80 dark:bg-zinc-800/80 px-3 py-1 rounded-xl border border-slate-200/60 dark:border-zinc-700/60">
              ...
              <span className="text-slate-300 dark:text-zinc-700">|</span>
              <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-red-500" /> {language === 'am' ? 'አልተወሰደም' : 'Not Marked'}</span>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold rounded-2xl shadow-md hover:scale-[1.02] active:scale-[0.98] transition text-sm w-full sm:w-auto shrink-0 cursor-pointer"
        >
