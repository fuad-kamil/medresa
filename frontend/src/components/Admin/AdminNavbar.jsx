...
export default function AdminNavbar() {
  ...
  return (
    <nav className="bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md border-b border-slate-100 dark:border-zinc-900 h-20 pl-20 pr-6 lg:px-10 fixed top-0 right-0 left-0 lg:left-72 z-30 shadow-xs flex items-center">
