          ...
          <div className="flex items-center justify-between border-b-4 border-emerald-600 pb-6 mb-8">
            <div className="flex items-center gap-4">
              ...
              <img src="/logo.png" alt="Medresa Logo" className="w-24 h-24 object-contain" onError={(e) => {
                // Fallback if logo is not found, render a colored div
                e.target.style.display = 'none';
              }} />
              <div className="w-24 h-24 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600 font-bold text-3xl hidden" id="logo-fallback">
                M
              </div>
              <div>
