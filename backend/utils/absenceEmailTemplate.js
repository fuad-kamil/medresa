      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 24px;">
          ...
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="${student.photo}?t=${new Date().getTime()}" alt="${student.fullName}" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 3px solid #f44336; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
          </div>
          ` : ''}
