...
const translations = {
  en: {
    ...
    inputLabel: 'Father / Mother Phone Number or Roster ID',
    inputPlaceholder: 'e.g. 0911223344 or Class No. (1, 2, 3...)',
    helperText: 'Enter any registered phone number or your student index number on the class list.',
    ...
    emptyIdentifierError: 'Please enter your phone number or class index number.',
  ...
  am: {
    ...
    inputLabel: 'የአባት/እናት ስልክ ቁጥር ወይም የተማሪ መለያ ቁጥር',
    inputPlaceholder: 'ምሳሌ፡ 0911223344 ወይም የክፍል መለያ (1, 2, 3...)',
    helperText: 'የተመዘገበ ስልክ ቁጥር ወይም በክፍል ዝርዝር ውስጥ ያለውን የተማሪ መለያ ቁጥር ያስገቡ።',
    submitBtn: 'ፈተናውን ጀምር ➔',
    ...
    emptyIdentifierError: 'እባክዎን የስልክ ቁጥር ወይም የተማሪ መለያ ቁጥር ያስገቡ።',
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        throw new Error(data.message || t('verificationFailedError'));
      }
