...
const translations = {
  en: {
    ...
    emptyIdentifierError: 'Please enter your exam login code.',
    verificationFailedError: 'Student verification failed.',
    studentNotFoundError: 'Invalid exam code. Please enter your exam login code.',
  ...
  am: {
    ...
    emptyIdentifierError: 'እባክዎን የፈተና መግቢያ ኮድዎን ያስገቡ።',
    verificationFailedError: 'የተማሪ ማንነት ማረጋገጥ አልተሳካም።',
    studentNotFoundError: 'ትክክለኛ ያልሆነ የፈተና ኮድ። እባክዎን የፈተና ኮድዎን ያስገቡ።',
